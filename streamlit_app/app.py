...
with col_gh:
    st.link_button("⭐ GitHub",   "https://github.com/yourusername/cifar10-cnn-classifier")
with col_li:
    st.link_button("💼 LinkedIn", "https://linkedin.com/in/yourprofile")
with col_nb:
    st.link_button("📓 Notebook", "https://github.com/yourusername/cifar10-cnn-classifier/blob/main/notebooks/CIFAR10_Analysis.ipynb")
